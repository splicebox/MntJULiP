...
4 files are generated by MntJULiP,   
intron_data.txt: contains information of the introns (splice junctions), coordinate, read counts, etc;  
diff_introns.txt: contains the results of the differential intron abundance;  
diff_spliced_introns.txt & diff_spliced_groups.txt: contains the results of the differential intron splicing ratio.  

Besides, there is a fold named 'data' generated by MntJULiP containing the .splice files. 
