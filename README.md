...
### <a name="support"></a> Support and Education
Contact: Please submit an [Issue](https://github.com/splicebox/MntJULiP/issues) through this Github page. For demos on how to use the software, please see our Coursera [transcriptomics](https://www.coursera.org/learn/bioinformatics-methods-for-transcriptomics) course.
